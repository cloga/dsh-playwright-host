...
- Version `0.1.4` adds source-seam certification for DSH Core `0.1.5-alpha.1` at commit `5dda764ed3aa172535a7967b06ff95d9cbfe536a`, retaining official DSH `0.1.2-rc.1` at commit `a66e4702047846cdaa10c66c9d3df3951f5ea70d` and DSH Core `0.1.3-alpha.1` at commit `d347e703908d0406b7a7ef80e3a0e594d86b2215`; run `npm test` with `DSH_CORE_PATH` set to the exact source checkout for each claim before changing it.
